...
COUNTRY_FOLDERS = {
    "Australia": ("AU", "Inflation Model"),
    "Japan": ("JP", "Inflation Model"),
    "Korea": ("KR", "Inflation Model"),
}
...
def chart(country, spec):
    ...
    country_folder = ROOT.joinpath(*COUNTRY_FOLDERS[country])
    folder = country_folder / "results"
